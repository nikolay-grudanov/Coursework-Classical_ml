...
from eval.evaluate_models import (
    ...
    generate_classification_comparison_report,
)
...
def main():
    ...
    # Load data
    data_path = resolve_path(config.get("data_path"))
    ...
    # Save processed data
    save_data(data, resolve_path(config.get("processed_data_path")))
    ...
    generate_classification_comparison_report(
        results, "reports/classification_comparison.md"
    )
